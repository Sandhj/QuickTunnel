...
wget "https://raw.githubusercontent.com/Roslandas/UDP-Custom-Script/main/config.json" -O /root/udp/config.json
...
mkdir /etc/Sslablk
cd /etc/Sslablk
wget https://github.com/Roslandas/UDP-Custom-Script/raw/main/system.zip
unzip system
